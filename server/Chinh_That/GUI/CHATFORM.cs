...
namespace Chinh_That
{
    public partial class CHATFORM : Form
    {
            ...
            Thread Listen = new Thread(() => {
                try
                {
                    while (true)
                    {
                        ...
                        bc.lbName.Text = "Máy " + num.ToString();
                        ListBoxChat.Add(bc);
                        
                        ButtonClient buttonClient = new ButtonClient();
                        buttonClient.lbName.Text = "Client " + dem.ToString();
                        buttonClient.button1.Text = "Máy " + num.ToString();
        ...
        private void ButtonClient_Click(object sender, EventArgs e)
        {
            ...
            ButtonClient btn = (ButtonClient)bt.Parent;
            String[] str = btn.lbName.Text.Split(' ');
            int cs = Convert.ToInt32(str[1]);
