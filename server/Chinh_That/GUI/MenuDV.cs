...
namespace Chinh_That
{
    public partial class MenuDV : Form
    {
        ...
        RECEIVEFEEDBACK rf = new RECEIVEFEEDBACK();
        
        public MenuDV(string user_name, string role_name)
        {
            InitializeComponent();
            ...
            manage1.button1.Click += Button1_Click1;
            news1.Visible = false;
        ...
        {
            if (this.role_name == "staff" || this.role_name == "Admin")
            {
                Home h = new Home(role_name);
                h.Show();
            }
            else
            {
                MessageBox.Show("Bạn phải có quyền Admin hoặc Staff mới sử dụng được chức năng này!","Thông báo",MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void BtnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            if (dlr == DialogResult.Yes)
            {
                foreach (CARTITEM ci in addcart1.flowLayoutPanel1.Controls)
                {
                    ...
                    pn.btnExit.BackColor = ci.panel1.BackColor;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (!cancel)
            {
                ...
                cARTITEM.btnExit.BackColor = btd.button1.BackColor;
        ...
        {
            ro.Show();
            ro.loadFLPFEEDBACK(rf.getPNewsList());
        }
